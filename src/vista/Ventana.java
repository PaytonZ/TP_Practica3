...
public class Ventana extends JFrame implements InterfaceEjecuta {
	...
	lblCiclista0 = crearJLabel(lblCiclista0, "Ciclista0",
		Constantes.X_INICIAL, Constantes.Y_INICIAL,
		Constantes.ANCHO_BOTON, Constantes.ALTO_BOTON,
		Constantes.COLOR_CIC_0);
	colocarJLabelEnJPanel(lblCiclista0, contentPane);

	textArea_ciclista0 = crearJTextArea(textArea_ciclista0,
		lblCiclista0.getX(), lblCiclista0.getHeight(),
	...
	botonDisCad0 = crearJButton(botonDisCad0, Constantes.CADENCIA_MENOS,
		textArea_ciclista0.getWidth() + textArea_ciclista0.getX(),
		textArea_ciclista0.getY(), Constantes.ANCHO_BOTON,
		Constantes.ALTO_BOTON);

	escuchador.asignaMouseClicked(botonDisCad0, "asignacadencia 0 "
	...
	botonAumCad0 = crearJButton(botonAumCad0, Constantes.CADENCIA_MAS,
		textArea_ciclista0.getWidth() + textArea_ciclista0.getX(),
		botonDisCad0.getY() + Constantes.ALTO_BOTON,
		Constantes.ANCHO_BOTON, Constantes.ALTO_BOTON);
	escuchador.asignaMouseClicked(botonAumCad0, "asignacadencia 0 "
	...
	botonDisPin0 = crearJButton(botonDisPin0, Constantes.PINON_MENOS,
		textArea_ciclista0.getWidth() + textArea_ciclista0.getX(),
		botonAumCad0.getY() + Constantes.ALTO_BOTON,
		Constantes.ANCHO_BOTON, Constantes.ALTO_BOTON);
	...
	botonAumPin0 = crearJButton(botonAumPin0, Constantes.PINON_MAS,
		textArea_ciclista0.getWidth() + textArea_ciclista0.getX(),
		botonDisPin0.getY() + Constantes.ALTO_BOTON,
		Constantes.ANCHO_BOTON, Constantes.ALTO_BOTON);
	...
	botonDisPla0 = crearJButton(botonDisPla0, Constantes.PLATO_MENOS,
		botonDisCad0.getWidth() + botonDisCad0.getX(),
		textArea_ciclista0.getY(), Constantes.ANCHO_BOTON,
		Constantes.ALTO_BOTON);
	...
	botonAumPla0 = crearJButton(botonAumPla0, Constantes.PLATO_MAS,
		botonAumCad0.getWidth() + botonAumCad0.getX(),
	...
	botonFrenaPoco0 = crearJButton(botonFrenaPoco0, Constantes.FRENO_MENOS,
	...
	botonFrenaMas0 = crearJButton(botonFrenaMas0, Constantes.FRENO_MAS,
		botonAumPin0.getWidth() + botonAumPin0.getX(),
	...
	textArea_ciclista1 = crearJTextArea(textArea_ciclista1,
		textArea_ciclista0.getX() + textArea_ciclista0.getWidth() + 2
			* Constantes.ANCHO_BOTON, textArea_ciclista0.getY(),
		Constantes.ANCHO_TEXTBOX, Constantes.ALTO_TEXTBOX);
	colocarJTextAreaEnJPanel(textArea_ciclista1, contentPane);
	//
	JButton botonDisCad1 = null;
	botonDisCad1 = crearJButton(botonDisCad1, Constantes.CADENCIA_MENOS,
		textArea_ciclista1.getWidth() + textArea_ciclista1.getX(),
		textArea_ciclista1.getY(), Constantes.ANCHO_BOTON,
		Constantes.ALTO_BOTON);

	escuchador.asignaMouseClicked(botonDisCad1, "asignacadencia 1 "
		+ Constantes.BAJA_CADENCIA);

	colocarJButtonEnJPanel(botonDisCad1, contentPane);
	//
	JButton botonAumCad1 = null;
	botonAumCad1 = crearJButton(botonAumCad1, Constantes.CADENCIA_MAS,
		textArea_ciclista1.getWidth() + textArea_ciclista1.getX(),
		botonDisCad1.getY() + Constantes.ALTO_BOTON,
		Constantes.ANCHO_BOTON, Constantes.ALTO_BOTON);
	escuchador.asignaMouseClicked(botonAumCad1, "asignacadencia 1 "
		+ Constantes.SUBE_CADENCIA);

	colocarJButtonEnJPanel(botonAumCad1, contentPane);
	//
	JButton botonDisPin1 = null;
	botonDisPin1 = crearJButton(botonDisPin1, Constantes.PINON_MENOS,
		textArea_ciclista1.getWidth() + textArea_ciclista1.getX(),
		botonAumCad1.getY() + Constantes.ALTO_BOTON,
		Constantes.ANCHO_BOTON, Constantes.ALTO_BOTON);
	...
	botonAumPin1 = crearJButton(botonAumPin1, Constantes.PINON_MAS,
		textArea_ciclista1.getWidth() + textArea_ciclista1.getX(),
		botonDisPin1.getY() + Constantes.ALTO_BOTON,
		Constantes.ANCHO_BOTON, Constantes.ALTO_BOTON);
	...
	botonDisPla1 = crearJButton(botonDisPla1, Constantes.PLATO_MENOS,
		botonDisCad1.getWidth() + botonDisCad1.getX(),
		textArea_ciclista1.getY(), Constantes.ANCHO_BOTON,
		Constantes.ALTO_BOTON);
	...
	botonAumPla1 = crearJButton(botonAumPla1, Constantes.PLATO_MAS,
		botonAumCad1.getWidth() + botonAumCad1.getX(),
	...
	botonFrenaPoco1 = crearJButton(botonFrenaPoco1, Constantes.FRENO_MENOS,
	...
	botonFrenaMas1 = crearJButton(botonFrenaMas1, Constantes.FRENO_MAS,
		botonAumPin1.getWidth() + botonAumPin1.getX(),
	...
	botonDisCad2 = crearJButton(botonDisCad2, Constantes.CADENCIA_MENOS,
		textArea_ciclista2.getWidth() + textArea_ciclista2.getX(),
		textArea_ciclista2.getY(), Constantes.ANCHO_BOTON,
		Constantes.ALTO_BOTON);

	escuchador.asignaMouseClicked(botonDisCad2, "asignacadencia 2 "
		+ Constantes.BAJA_CADENCIA);

	colocarJButtonEnJPanel(botonDisCad2, contentPane);
	//
	JButton botonAumCad2 = null;
	botonAumCad2 = crearJButton(botonAumCad2, Constantes.CADENCIA_MAS,
		textArea_ciclista2.getWidth() + textArea_ciclista2.getX(),
		botonDisCad2.getY() + Constantes.ALTO_BOTON,
		Constantes.ANCHO_BOTON, Constantes.ALTO_BOTON);
	escuchador.asignaMouseClicked(botonAumCad2, "asignacadencia 2 "
		+ Constantes.SUBE_CADENCIA);

	colocarJButtonEnJPanel(botonAumCad2, contentPane);
	//
	JButton botonDisPin2 = null;
	botonDisPin2 = crearJButton(botonDisPin2, Constantes.PINON_MENOS,
		textArea_ciclista2.getWidth() + textArea_ciclista2.getX(),
		botonAumCad2.getY() + Constantes.ALTO_BOTON,
		Constantes.ANCHO_BOTON, Constantes.ALTO_BOTON);
	...
	botonAumPin2 = crearJButton(botonAumPin2, Constantes.PINON_MAS,
		textArea_ciclista2.getWidth() + textArea_ciclista2.getX(),
		botonDisPin2.getY() + Constantes.ALTO_BOTON,
		Constantes.ANCHO_BOTON, Constantes.ALTO_BOTON);
	...
	botonDisPla2 = crearJButton(botonDisPla2, Constantes.PLATO_MENOS,
		botonDisCad2.getWidth() + botonDisCad2.getX(),
		textArea_ciclista2.getY(), Constantes.ANCHO_BOTON,
		Constantes.ALTO_BOTON);
	...
	botonAumPla2 = crearJButton(botonAumPla2, Constantes.PLATO_MAS,
		botonAumCad2.getWidth() + botonAumCad2.getX(),
	...
	botonFrenaPoco2 = crearJButton(botonFrenaPoco2, Constantes.FRENO_MENOS,
	...
	botonFrenaMas2 = crearJButton(botonFrenaMas2, Constantes.FRENO_MAS,
		botonAumPin2.getWidth() + botonAumPin2.getX(),
	...
	lblCiclista3 = crearJLabel(lblCiclista3, "Ciclista3",
		textArea_ciclista0.getX(),
		lblCiclista0.getY() + lblCiclista0.getHeight()
			+ textArea_ciclista0.getHeight(),
		Constantes.ANCHO_BOTON, Constantes.ALTO_BOTON,
		Constantes.COLOR_CIC_3);
	...
	botonDisCad3 = crearJButton(botonDisCad3, Constantes.CADENCIA_MENOS,
		textArea_ciclista3.getWidth() + textArea_ciclista3.getX(),
		textArea_ciclista3.getY(), Constantes.ANCHO_BOTON,
		Constantes.ALTO_BOTON);

	escuchador.asignaMouseClicked(botonDisCad3, "asignacadencia 3 "
		+ Constantes.BAJA_CADENCIA);

	colocarJButtonEnJPanel(botonDisCad3, contentPane);
	//
	JButton botonAumCad3 = null;
	botonAumCad3 = crearJButton(botonAumCad3, Constantes.CADENCIA_MAS,
		textArea_ciclista3.getWidth() + textArea_ciclista3.getX(),
		botonDisCad3.getY() + Constantes.ALTO_BOTON,
		Constantes.ANCHO_BOTON, Constantes.ALTO_BOTON);
	escuchador.asignaMouseClicked(botonAumCad3, "asignacadencia 3 "
		+ Constantes.SUBE_CADENCIA);
	...
	botonDisPin3 = crearJButton(botonDisPin3, Constantes.PINON_MENOS,
		textArea_ciclista3.getWidth() + textArea_ciclista3.getX(),
		botonAumCad3.getY() + Constantes.ALTO_BOTON,
		Constantes.ANCHO_BOTON, Constantes.ALTO_BOTON);
	...
	botonAumPin3 = crearJButton(botonAumPin3, Constantes.PINON_MAS,
		textArea_ciclista3.getWidth() + textArea_ciclista3.getX(),
		botonDisPin3.getY() + Constantes.ALTO_BOTON,
		Constantes.ANCHO_BOTON, Constantes.ALTO_BOTON);
	...
	botonDisPla3 = crearJButton(botonDisPla3, Constantes.PLATO_MENOS,
		botonDisCad3.getWidth() + botonDisCad3.getX(),
		textArea_ciclista3.getY(), Constantes.ANCHO_BOTON,
		Constantes.ALTO_BOTON);
	...
	botonAumPla3 = crearJButton(botonAumPla3, Constantes.PLATO_MAS,
		botonAumCad3.getWidth() + botonAumCad3.getX(),
	...
	botonFrenaPoco3 = crearJButton(botonFrenaPoco3, Constantes.FRENO_MENOS,
	...
	botonFrenaMas3 = crearJButton(botonFrenaMas3, Constantes.FRENO_MAS,
		botonAumPin3.getWidth() + botonAumPin3.getX(),
	...
	botonDisCad4 = crearJButton(botonDisCad4, Constantes.CADENCIA_MENOS,
		textArea_ciclista4.getWidth() + textArea_ciclista4.getX(),
		textArea_ciclista4.getY(), Constantes.ANCHO_BOTON,
		Constantes.ALTO_BOTON);

	escuchador.asignaMouseClicked(botonDisCad4, "asignacadencia 4 "
		+ Constantes.BAJA_CADENCIA);

	colocarJButtonEnJPanel(botonDisCad4, contentPane);
	//
	JButton botonAumCad4 = null;
	botonAumCad4 = crearJButton(botonAumCad4, Constantes.CADENCIA_MAS,
		textArea_ciclista4.getWidth() + textArea_ciclista4.getX(),
		botonDisCad4.getY() + Constantes.ALTO_BOTON,
		Constantes.ANCHO_BOTON, Constantes.ALTO_BOTON);
	escuchador.asignaMouseClicked(botonAumCad4, "asignacadencia 4 "
		+ Constantes.SUBE_CADENCIA);

	colocarJButtonEnJPanel(botonAumCad4, contentPane);
	//
	JButton botonDisPin4 = null;
	botonDisPin4 = crearJButton(botonDisPin4, Constantes.PINON_MENOS,
		textArea_ciclista4.getWidth() + textArea_ciclista4.getX(),
		botonAumCad4.getY() + Constantes.ALTO_BOTON,
		Constantes.ANCHO_BOTON, Constantes.ALTO_BOTON);
	...
	botonAumPin4 = crearJButton(botonAumPin4, Constantes.PINON_MAS,
		textArea_ciclista4.getWidth() + textArea_ciclista4.getX(),
		botonDisPin4.getY() + Constantes.ALTO_BOTON,
		Constantes.ANCHO_BOTON, Constantes.ALTO_BOTON);
	...
	botonDisPla4 = crearJButton(botonDisPla4, Constantes.PLATO_MENOS,
		botonDisCad4.getWidth() + botonDisCad4.getX(),
		textArea_ciclista4.getY(), Constantes.ANCHO_BOTON,
		Constantes.ALTO_BOTON);
	...
	botonAumPla4 = crearJButton(botonAumPla4, Constantes.PLATO_MAS,
		botonAumCad4.getWidth() + botonAumCad4.getX(),
	...
	botonFrenaPoco4 = crearJButton(botonFrenaPoco4, Constantes.FRENO_MENOS,
	...
	botonFrenaMas4 = crearJButton(botonFrenaMas4, Constantes.FRENO_MAS,
		botonAumPin4.getWidth() + botonAumPin4.getX(),
	...
	botonDisCad5 = crearJButton(botonDisCad5, Constantes.CADENCIA_MENOS,
		textArea_ciclista5.getWidth() + textArea_ciclista5.getX(),
		textArea_ciclista5.getY(), Constantes.ANCHO_BOTON,
		Constantes.ALTO_BOTON);

	escuchador.asignaMouseClicked(botonDisCad5, "asignacadencia 5 "
		+ Constantes.BAJA_CADENCIA);

	colocarJButtonEnJPanel(botonDisCad5, contentPane);
	//
	JButton botonAumCad5 = null;
	botonAumCad5 = crearJButton(botonAumCad5, Constantes.CADENCIA_MAS,
		textArea_ciclista5.getWidth() + textArea_ciclista5.getX(),
		botonDisCad5.getY() + Constantes.ALTO_BOTON,
		Constantes.ANCHO_BOTON, Constantes.ALTO_BOTON);
	escuchador.asignaMouseClicked(botonAumCad5, "asignacadencia 5 "
		+ Constantes.SUBE_CADENCIA);

	colocarJButtonEnJPanel(botonAumCad5, contentPane);
	//
	JButton botonDisPin5 = null;
	botonDisPin5 = crearJButton(botonDisPin5, Constantes.PINON_MENOS,
		textArea_ciclista5.getWidth() + textArea_ciclista5.getX(),
		botonAumCad5.getY() + Constantes.ALTO_BOTON,
		Constantes.ANCHO_BOTON, Constantes.ALTO_BOTON);
	...
	botonAumPin5 = crearJButton(botonAumPin5, Constantes.PINON_MAS,
		textArea_ciclista5.getWidth() + textArea_ciclista5.getX(),
		botonDisPin5.getY() + Constantes.ALTO_BOTON,
		Constantes.ANCHO_BOTON, Constantes.ALTO_BOTON);
	...
	botonDisPla5 = crearJButton(botonDisPla5, Constantes.PLATO_MENOS,
		botonDisCad5.getWidth() + botonDisCad5.getX(),
		textArea_ciclista5.getY(), Constantes.ANCHO_BOTON,
		Constantes.ALTO_BOTON);
	...
	botonAumPla5 = crearJButton(botonAumPla5, Constantes.PLATO_MAS,
		botonAumCad5.getWidth() + botonAumCad5.getX(),
	...
	botonFrenaPoco5 = crearJButton(botonFrenaPoco5, Constantes.FRENO_MENOS,
	...
	botonFrenaMas5 = crearJButton(botonFrenaMas5, Constantes.FRENO_MAS,
		botonAumPin5.getWidth() + botonAumPin5.getX(),
	...
	lblComandos = crearJLabel(lblComandos, "Comandos",
		textArea_ciclista4.getX(), textArea_ciclista4.getY()
			+ textArea_ciclista4.getHeight(), 114, 15, Color.black);
	...
	JLabel lblConsola = crearJLabel(lblComandos, "Consola",
		textArea_ciclista5.getX(), textArea_ciclista4.getY()
			+ textArea_ciclista4.getHeight(), 114, 15, Color.black);
